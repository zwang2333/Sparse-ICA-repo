...
# 01: Perform subject-level PCA on ABIDEI-NYU data
...
# Perform subject-level PCA on ABIDEI-NYU subjects
cat("###########################################################################\n")
cat("#################### Start PCA on ABIDEI-NYU ##############################\n")
cat("###########################################################################\n")
...
for (i in 1:dim(my_list)[1]) {
  ...
  save(PC,file=paste0("/home/zwan873/Real_Data_Application/sub_PC/ABIDEI-NYU/",my_list$SUB_ID[i],"_PC",npc,"_cortex_9p_iter.RData"))
