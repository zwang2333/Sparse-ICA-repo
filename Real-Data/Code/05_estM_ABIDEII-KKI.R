...
# 05: Estimate mixing matrix for each subject in ABIDEII-KKI
...
for (i in 1:dim(my_list)[1]) {
  ...
  save(my_M,file=paste0("/home/zwan873/Real_Data_Application/est_M_sparseICA/ABIDEII-KKI/",my_list$SUB_ID[i],"_estM_subPC85.RData"))
