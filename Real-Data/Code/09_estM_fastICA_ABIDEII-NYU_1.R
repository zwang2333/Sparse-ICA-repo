...
# Estimate M on ABIDEII-NYU_1 subjects
cat("###########################################################################\n")
cat("################## Estimate M matrix on ABIDEII-NYU_1 #####################\n")
cat("###########################################################################\n")
...
for (i in 1:dim(my_list)[1]) {
  ...
  save(my_M,file=paste0("/home/zwan873/Real_Data_Application/est_M_fastICA/ABIDEII-NYU_1/",my_list$SUB_ID[i],"_estM_subPC85.RData"))
